      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "527a6be7-2-" + i0 + "-" + i1 + "," + ("527a6be7-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "527a6be7-1-" + i0 + ",527a6be7-0"
      } : {}, {
        c: data,
        g: "527a6be7-3-" + i0 + ",527a6be7-0",
        h: common_vendor.p({
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/linma/Documents/HBuilderProjects/test-error/pages/opendb-feedback/list.vue"]]);
